...
if __name__ == '__main__':
	...
	parser.add_argument('-lr'		,'--learning-rate'	,type=float , default=3e-4		,help='Optmizer (default = 0.01)')
	...
	out_dim = dim // model_stride
	Ytrain = np.empty((batch_size, out_dim, out_dim, 2*4+1))
